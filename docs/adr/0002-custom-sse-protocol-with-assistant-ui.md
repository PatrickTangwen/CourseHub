...
- The event vocabulary is a private contract: any backend pipeline change that renames stages or tools must update the spec (`docs/specs/coursehub-frontend.md` §3.1), both test suites, and the frontend display-name mapping.
