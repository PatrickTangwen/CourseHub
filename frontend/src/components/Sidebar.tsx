...
const ThreadListItem = () => (
  <ThreadListItemPrimitive.Root className="group flex items-center gap-1 rounded-lg hover:bg-zinc-100 data-active:bg-zinc-100 dark:hover:bg-zinc-800 dark:data-active:bg-zinc-800">
    <ThreadListItemPrimitive.Trigger className="min-w-0 flex-1 truncate px-2.5 py-2 text-left text-sm">
...
export const Sidebar = () => (
  <aside
    ...
    className="flex h-full w-64 shrink-0 flex-col border-r border-zinc-200 bg-zinc-50/50 dark:border-zinc-800 dark:bg-zinc-900/50"
  >
    <div className="p-3">
      <ThreadListPrimitive.New className="w-full rounded-xl border border-zinc-300 px-3 py-2 text-left text-sm hover:bg-zinc-100 dark:border-zinc-700 dark:hover:bg-zinc-800">
        + {STRINGS.newChat}
